        ...
        <div class="wrapper">
            <div class="">
                ...
                <div class="">
                    ...
                    <a href="<%=request.getContextPath()%>/admin/danhmuc/new" class="btn btn-success New">Thêm mới danh mục</a>
                </div>
                <br>
                        ...
                        <c:forEach var="danhmuc" items="${listDanhMuc}">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <img style="width: 50%; height: auto"  src="<%=request.getContextPath()%>/uploads/<c:out value="${danhmuc.anhdanhmuc}" />">
                                ...
                                <td>
                                    <a class="Edit" href="edit?id=<c:out value='${danhmuc.id}' />">Edit</a> &nbsp;&nbsp;&nbsp;&nbsp; 
                                    <a class="Delete" onclick="return confirm('Are you sure you want to delete this item?');" href="delete?id=<c:out value='${danhmuc.id}' />">Delete</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
